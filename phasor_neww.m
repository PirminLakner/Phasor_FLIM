function phasor_neww(thresh,harmonic,singleorbatch)

% thresh is threshold. [0:1]
% harmonic is harmonic number. [1,2,3,...]
% singleorbatch determins if a single calculation is made or batch
% options are 'single' and 'batch'
...
for jj = 3:numel(datadir) % start with 3, because 1 and 2 are "." and ".." in folder
    ...
    % Threshold (not peak vs peak. Used Whole intesity vs max whole intensity)
    ...
    % Binning and 2D histogram addapted from:
    % https://stackoverflow.com/questions/6777609/fast-2dimensional-histograming-in-matlab/6778256#6778256
